...
if (isset($_POST['btnsave'])) {
  ...
  if (empty($link)) {
    $errMSG = "Por favor, insira o link de redirecionamento";
  }
  ...
  if (!isset($errMSG)) {
    $stmt = $DB_con->prepare('INSERT INTO posts (titulo,subtitulo,descricao,link,texto_1,img,autor,tipo) VALUES(:utitulo,:usubtitulo,:udescricao,:ulink,:utexto_1,:upic,:uautor,:utipo)');
                ...
                <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                  <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-wrap">
                      ...
                      <div class="w-full lg:w-6/12 px-4">
                        <div class="relative w-full mb-3">
                          ...
                          <input value="<?php echo $link; ?>" name="link" type="text" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" placeholder="Link de redirecinoamento da postagem" />
                        </div>
                      </div>
                      ...
                      <div class="w-full lg:w-12/12 px-4">
                        <div class="relative w-full mb-3">
                          ...
                          <input class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="<?php echo $texto_1; ?>" name="texto_1" type="text" id="default" placeholder="Texto da postagem"></input>
                        </div>
                      </div>
                      ...
                      <div class="w-full lg:w-6/12 px-4">
                        <div class="relative w-full mb-3">
                          ...
                          <input value="<?php echo $descricao; ?>" name="descricao" type="text" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" placeholder="SOMENTE PARA NOTICIAS" />
                        </div>
                      </div>
                      <div class="w-full lg:w-6/12 px-4">
                    ...
                    <div class="flex flex-wrap">
                      ...
                      <button style="margin:20px" class="bg-blueadv text-white active:bg-pink-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150" type="submit" name="btnsave">
                        Adicionar
                      </button>
                    </div>
                  </form>
