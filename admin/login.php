        ...
        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
          ...
          <div class="d-flex justify-content-center py-4">
            <a href="index.html" class="logo d-flex align-items-center w-auto">
              <img src="../assets/img/Ruan Leal Logo2 1.png" style="max-width: 200px; max-height: 90px;" alt="">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
              ...
              <div class="pt-4 pb-2">
                <h5 style="color: #d99253;" class="card-title text-center pb-0 fs-4">Entrar no Sistema</h5>
              </div>
              <form class="row g-3" action="" method="POST">
                ...
                <div class="col-12">
                  <button style="background-color: #d99253; border: none;" type="submit" name="ok" class="btn btn-primary w-100">Login</button>
                </div>
              <?php
                if (isset($successMSG)) {
